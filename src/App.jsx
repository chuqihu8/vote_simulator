...
function PersonFigure({ x, y, propensity, voted, isSelected, isCF, nodeId, onClick }) {
  ...
  return (
    <g transform={`translate(${x},${y})`} onClick={onClick} style={{ cursor: "pointer" }}>
      ...
      {/* ID pill below feet */}
      <rect x="-10" y="29" width="20" height="13" rx="3.5" fill={bodyColor} stroke={strokeC} strokeWidth="1.2" style={{ pointerEvents: "none" }} />
      <text y="35.5" textAnchor="middle" dominantBaseline="middle" fontSize="9" fill={textC} fontWeight="700" fontFamily="'DM Mono',monospace" style={{ pointerEvents: "none" }}>{nodeId}</text>

      {/* Propensity label */}
      <text y="49" textAnchor="middle" fontSize="6" fill={voted ? "#e85d42" : "#475569"} fontWeight="600" fontFamily="'DM Mono',monospace" style={{ pointerEvents: "none" }}>
