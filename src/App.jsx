...
function SetupPage({ setupNodes, setupEdges, setupNodeCount, handleSetupNodeCount, handleSetupNodeField,
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 100, background: "#f8fafc", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      <style>{`
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <div className="sp-scrollbar" style={{ width: 260, borderRight: "1.5px solid #e2e8f0", background: "white", display: "flex", flexDirection: "column", padding: "24px 20px", overflowY: "auto", flexShrink: 0 }}>
        ...
        <div style={{ width: 360, borderLeft: "1.5px solid #e2e8f0", background: "#f8fafc", display: "flex", flexDirection: "column", flexShrink: 0 }}>
